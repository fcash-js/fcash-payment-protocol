...
var ECDSA = fcash.crypto.ECDSA;
var sha256sha256 = fcash.crypto.Hash.sha256sha256;
var varintBufNum = fcash.encoding.BufferWriter.varintBufNum;
...
function magicHash(str) {
  var magicBytes = new Buffer('Fcash Signed Message:\n');
